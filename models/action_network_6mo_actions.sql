...
SELECT 
  ...
  -- Taxonomy Block G: universal Activity section (cat 35)
  CONCAT('Activity:|:Action Network Actions (Past 6 Months):|:Action Network Actions (Past 6 Months):|:number_response:', CAST(total_actions_6_months AS STRING)) as action_network_6mo_sync_string,
