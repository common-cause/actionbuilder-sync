-- deduplicated_names_to_load_bq_only: the original BQ-only new-record insertion feed.
--
-- This is the full insertion logic based purely on BQ data. It is wrapped by
-- deduplicated_names_to_load (the operational view) which adds sync_log filtering
-- to exclude person_ids already successfully inserted by insert_new_records.
--
-- To revert to BQ-only mode: delete deduplicated_names_to_load.sql and rename
-- this file back to deduplicated_names_to_load.sql.
