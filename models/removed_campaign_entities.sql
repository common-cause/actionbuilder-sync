...
--   remove_suppressed      — remove_suppressed (curated suppression_list; do-not-sync people)
...
WHERE operation IN ('remove_from_campaign', 'remove_ep_external', 'remove_mobilize_external', 'remove_ot_duplicate', 'remove_suppressed')
