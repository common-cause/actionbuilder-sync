...
- **Note:** the temporary `--organizer "Carlos,Luana,Rommel"` filter (which held back Lamair Bryan's members while he had no AB account) was removed 2026-07-29 after his account activated — his entity was connected to campaign 26 and his 141 members assigned that day. All four organizers now flow nightly. Prereq for any future organizer: both ends of a connection must be members of campaign 26 — connect via `update_entity_with_tags(26, interact_id, [])`, NOT the AB UI (the UI add was observed not to persist, 2026-07-02).
